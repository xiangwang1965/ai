      ...
      <el-form
        ...
        <div class="inputWrap cac-shadow">
          ...
          <el-form-item label="班级名称" prop="class_name" class="createForm--formItem">
            <el-input v-model.trim="params.class_name" placeholder="班级名称" class="createForm__input"></el-input>
          </el-form-item>
          ...
          <el-form-item label="辅导老师" prop="teacher_id" class="createForm--formItem">
            <el-select v-model="params.teacher_id" placeholder="辅导老师" filterable :disabled="params.status===3">
