<template>
  <div id="classContainer" class="classContainer">
            ...
            <div class="lesson_step_list">
              ...
              >
                <div class="lesson_box">
                  <div class="lesson_item_icon"></div>
                  <div class="lesson_name">{{item.name}}</div>
                  <div class="lesson_info">
                    <div class="lesson_info_locked_img" v-if="item.locked==1">
    ...
    <el-dialog
      ...
      @close="dialogClose"
    >
      <course-report ref="courseReport" v-on:refresh="refresh"></course-report>
    </el-dialog>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    dialogOpen() {
      this.$refs.courseReport.getReportInfo(this.courseItem, this.userInfo.id);
    },
    dialogClose() {
      this.$refs.courseReport.isLoading = true;
    },
    refresh(data) {
    ...
    getCurrentCourses(typeId) {
      ...
      this.colorClassList.tab.stepLineClass =
        "step_line_label_" + this.bgsufix[typeId - 1];
