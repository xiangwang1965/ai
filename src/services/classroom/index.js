...
class Classroom extends CRUD {
    constructor() {
        ...
        this.getStuCourseHaveClassUrl = "/ws/api/course/getStuCourseHaveClass";
    }
    getUserInfo(params) {
    ...
    getStuCourseHaveClass(params){
        return this.sendGet(this.getStuCourseHaveClassUrl, params).then(res => {
            return res;
        });
    }
